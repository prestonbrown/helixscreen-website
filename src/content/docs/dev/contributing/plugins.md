...
See [LVGL9_XML_GUIDE.md](/dev/reference/xml-guide/) for complete XML reference.
...
- [LVGL9_XML_GUIDE.md](/dev/reference/xml-guide/) - Complete XML component reference
- [ARCHITECTURE.md](https://github.com/prestonbrown/helixscreen/blob/main/docs/devel/ARCHITECTURE.md) - HelixScreen system architecture
- [DEVELOPMENT.md](/dev/onboarding/development/) - Development environment setup
- [TESTING.md](/dev/reference/testing/) - Testing infrastructure
