...
- **[K1 Series Research](https://github.com/prestonbrown/helixscreen/blob/main/docs/devel/printer-research/CREALITY_K1_SERIES_RESEARCH.md)** — Detailed hardware and software research
- **[K1 vs K2 Community Comparison](https://github.com/prestonbrown/helixscreen/blob/main/docs/devel/printer-research/CREALITY_K1_VS_K2_COMMUNITY.md)** — Ecosystem differences
- **[User Setup Guide](/guide/creality-k1c-setup/)** — End-user installation walkthrough
